...
import { Share2, Target, Users, ArrowRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gold-light mb-4 font-playfair italic">
                Connecting authentically in the digital age.
              </p>

              <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-12">
                Engaging with audiences across social media platforms with authentic, meaningful content.
              </p>

              <Link
                href="/contact?context=digital-presence"
              ...
              {[
                {
                  ...
                  description: 'Real conversations. Genuine connections. No algorithms between us and the story.',
                },
                {
                  icon: <Target size={40} />,
                  title: 'Strategic Content',
                  description: 'Intentional messaging that reflects artistic vision while building meaningful community.',
                },
                {
                  icon: <Users size={40} />,
                  title: 'Community Building',
                  description: 'Cultivating a loyal, engaged audience that grows organically through shared values.',
                },
              ].map((pillar, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  ...
                  description: 'High-quality posts, stories, and updates that resonate.',
                },
                {
                  title: 'Audience Engagement',
                  description: 'Building relationships through meaningful interaction.',
                },
                {
                  title: 'Brand Consistency',
                  description: 'Cohesive messaging across all digital touchpoints.',
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="aspect-video bg-gradient-to-br from-gold/20 to-gold/5 rounded-lg border border-gold/30 mb-4 flex items-center justify-center">
                    <Share2 className="text-gold" size={48} />
                  </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-8">
                In an era of curated feeds and algorithm-driven content, I prioritize genuine engagement
                and meaningful storytelling. My digital presence is an extension of my artistic vision —
                strategic, intentional, and always authentic. Whether sharing creative processes, cultural
                commentary, or personal insights, every post serves to build deeper connections with the
                audience.
              </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-gold-light text-lg md:text-xl mb-8">
                Connect with me across platforms for updates, insights, and exclusive content.
              </p>
              <Link
                href="/contact?context=digital-presence"
