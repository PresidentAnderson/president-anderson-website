...
import { Video, Camera, Edit3, ArrowRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gold-light mb-4 font-playfair italic">
                Stories that resonate. Content that lasts.
              </p>

              <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-12">
                High-quality multimedia content designed to captivate audiences across all platforms.
              </p>

              <Link
                href="/contact?context=content-creation"
              ...
              {[
                {
                  ...
                  description: 'From social media to long-form, content optimized for every channel.',
                },
                {
                  icon: <Camera size={40} />,
                  title: 'Visual Excellence',
                  description: 'Cinematic quality that elevates your brand and message.',
                },
                {
                  icon: <Edit3 size={40} />,
                  title: 'Strategic Storytelling',
                  description: 'Content that doesn&apos;t just look good—it performs.',
                },
              ].map((pillar, index) => (
                <motion.div
                  key={index}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-8">
                In a world oversaturated with content, quality and authenticity stand out.
                I create multimedia content that engages, inspires, and drives results—whether
                it&apos;s for social media, brand campaigns, or long-form storytelling.
              </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-gold-light text-lg md:text-xl mb-8">
                Let&apos;s bring your vision to life with content that resonates.
              </p>
              <Link
                href="/contact?context=content-creation"
