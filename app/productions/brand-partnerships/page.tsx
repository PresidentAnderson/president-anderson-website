...
import { Handshake, Target, TrendingUp, ArrowRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gold-light mb-4 font-playfair italic">
                Collaborations built on mutual excellence.
              </p>

              <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-12">
                Strategic partnerships with premium brands that share a commitment to quality and authenticity.
              </p>

              <Link
                href="/contact?context=brand-partnerships"
              ...
              {[
                {
                  ...
                  description: 'Partnerships that feel natural, not forced. Your brand values meet creative integrity.',
                },
                {
                  icon: <Target size={40} />,
                  title: 'Strategic Integration',
                  description: 'Seamless brand integration across content, events, and experiences.',
                },
                {
                  icon: <TrendingUp size={40} />,
                  title: 'Measurable Impact',
                  description: 'Collaborations designed to elevate both brand presence and audience engagement.',
                },
              ].map((pillar, index) => (
                <motion.div
                  key={index}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="font-playfair text-3xl md:text-4xl font-bold text-white mb-6">
                Partnerships that amplify both voices.
              </h2>

              <p className="text-white/80 text-lg leading-relaxed mb-8">
                I work exclusively with brands that align with my values and aesthetic.
                These aren&apos;t endorsements—they&apos;re collaborations where creativity
                and commerce elevate each other.
              </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-gold-light text-lg md:text-xl mb-8">
                Strategic partnerships start with shared values and vision.
              </p>
              <Link
                href="/contact?context=brand-partnerships"
