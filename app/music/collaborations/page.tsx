...
import { Users, Lightbulb, TrendingUp, ArrowRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gold-light mb-4 font-playfair italic">
                Creating magic through unity.
              </p>

              <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-12">
                Working with talented artists to create unique musical experiences that transcend individual artistry.
              </p>

              <Link
                href="/contact?context=collaborations"
              ...
              {[
                {
                  ...
                  description: 'Combining unique perspectives and talents to create something greater than the sum of its parts.',
                },
                {
                  icon: <Users size={40} />,
                  title: 'Genre Fusion',
                  description: 'Breaking boundaries by blending styles, sounds, and artistic visions into fresh expressions.',
                },
                {
                  icon: <TrendingUp size={40} />,
                  title: 'Mutual Elevation',
                  description: 'Partnerships designed to amplify each artist&apos;s strengths and expand creative horizons.',
                },
              ].map((pillar, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  ...
                  description: 'Bringing unique voices together on collaborative tracks.',
                },
                {
                  title: 'Genre-Crossing Projects',
                  description: 'Exploring new sonic territories through creative fusion.',
                },
                {
                  title: 'Production Partnerships',
                  description: 'Co-creating soundscapes that push artistic boundaries.',
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="font-playfair text-3xl md:text-4xl font-bold text-white mb-6">
                Collaboration that elevates every artist.
              </h2>

              <p className="text-white/80 text-lg leading-relaxed mb-8">
                I believe the best music comes from genuine creative partnerships. Whether co-writing,
                featuring, or producing together, I bring the same commitment to excellence and artistic
                integrity to every collaboration. Let&apos;s create something that pushes both of our
                artistic visions forward.
              </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-gold-light text-lg md:text-xl mb-8">
                Great collaborations start with open conversations.
              </p>
              <Link
                href="/contact?context=collaborations"
